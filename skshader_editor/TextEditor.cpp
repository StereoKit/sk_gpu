...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::HLSL()
{
	...
	if (!inited)
	{
		...
		static const char* const identifier_signature[] = {
			...
			"any atan2(any y, any x)\nReturns the arctangent of of two values (y,x). The signs of the x and y parameters are used to determine the quadrant of the return values within the range of -pi to pi. The atan2 HLSL intrinsic function is well-defined for every point other than the origin, even if y equals 0 and x does not equal 0.", 
