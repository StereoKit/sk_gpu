...
#endif
	app_cube_shader = skr_pipeline_create(&app_cube_vs, &app_cube_ps);
	skr_pipeline_set_wireframe(&app_cube_shader, true);
...
#endif
	app_shader = skr_pipeline_create(&app_vs, &app_ps);
